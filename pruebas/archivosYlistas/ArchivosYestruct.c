...
typedef struct DATO
{ // aqui definir los datos a almacenarse en la lista
    int id;
    int entero;         // entero
    char *nombre;       // nombre
...
Registro creaRegistroAleatorio()
{ // crea un registro nuevo con datos aleatorios y devuelve una copia
...
void insertaEnListaDesdeArchivo(Lista *ptrListaObjetivo, FILE *ptrArchivoFuente)
{                                            // carga los registros del archivo en una lista, pila o cola dependiendo de como se trate la lista enlazada
...
void insertarEnCola(Registro dato, Lista *listaDestino)
