...
frecuencia */
 ...
 /* función que ordena un arreglo mediante el algoritmo del método de la
burbuja algorithm */
void ordenamBurbuja( int a[] )
{
  int pasada; /* contador de pasadas */
  int j; /* contador de comparaciones */
  int almacena; /* ubicación temporal utilizada para intercambiar los
  elementos */
 ...
 /* muestra el contenido del arreglo (20 valores por línea) */
void imprimeArreglo( const int a[] )
 {
 int j; /* contador */
 ...
 if ( j % 20 == 0 ) { /* comienza una nueva línea cada 20 valores * printf( "\n" );
 } /* fin de if */
